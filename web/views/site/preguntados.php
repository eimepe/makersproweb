...
document.location.href="preguntatres?id=<?php echo $preguntas->idvideo?>&puntos=<?php echo $puntos+100?>";
else
...
document.location.href="preguntatres?id=<?php echo $preguntas->idvideo?>&puntos=<?php echo $puntos?>";
else
document.location.href="index"; 
}
</script> 
