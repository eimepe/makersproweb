...
function pregunta()
{
if(confirm("Respuesta Correcta Desea Finalizar y Guardar Resultados?"))
document.location.href="finalizar?id=<?php echo $preguntas->idvideo?>&puntos=<?php echo $puntos+100?>";
else
...
function pregunta2()
{
if(confirm("Respuesta Incorrecta Desea Finalizar y Guardar Resultados?"))
document.location.href="finalizar?id=<?php echo $preguntas->idvideo?>&puntos=<?php echo $puntos?>";
else
document.location.href="index"; 
}
</script> 
